...
public class Solution {
    ...
    public static void main(String[] args) {
        System.out.print(char2);//2
        System.out.print(char1);//1
        System.out.print(char5);//5
        System.out.print(char9);//9
        System.out.print(char4);//4
        System.out.print(char8);//8
        System.out.print(char7);//7
        System.out.print(char6);//6
        System.out.print(char10);//10
        System.out.print(char3);//3
        System.out.println();
    }
}
